...
const Ph = () => {
  return (
    <div className=' w-auto mt-10 my-5  md:w-[1170px] md:h-[603px]  md:justify-center md:ml-10 opacity-100'>
        <h1 className='text-gray-400 text-opacity-100 text-3xl '>Contact Us</h1>
        <div className='flex justify-center '>
            <div className=' w-auto h-auto flex flex-col sm:w-[391px] sm:h-[369px] space-y-3 '>
        ...
        <input type="text" placeholder='Interested IN ' className='bg-gray-300 text-opacity-100  py-5 rounded-lg pl-4 bg-opacity-100' />
            ...
            <div className='w-aut0 h-369 md:w-[746] md:h-[369]'>
