...
const Proj = () => {
  return (
    <div className="  w- auto md:w-[1170px] md:h-[765]">
      ...
      <div className="flex-col space-y-3 md:flex md:flex-row md:space-x-4 md:justify-centermd: ml-10">
      ...
      <div className="flex-col mb-5 space-y-4 w-auto justify-center md:flex md:flex-row md:space-x-4 md:ml-10 md:w-270 md:h-255 ">
        <Image src="/image03.png" width={270} height={255} alt=""  className="w-470 ml-20 md:w-270 md:ml-0"/>
        <Image src="/image04.png" width={470} height={255} alt="" className="ml-10 md:ml-0"/>
        <Image src="/image05.png" width={370} height={255} alt="" className="ml-10 md:ml-0"/>
      </div>
