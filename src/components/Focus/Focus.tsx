...
const Focus = () => {
  return (
    <div className="flex-col  justify-center  md:w-[1170] md:h-[268] md:mt-20  md:justify-center md:items-center bg-opacity-100 ml-20 text-opacity-100">
      <h1 className="text-gray-400 text-opacity-100 text-3xl ml-10 mb-5 text-start">Main Focus/Mission Statement</h1>
      <div className="flex justify-center opacity-100 ml-20 items-center ">
        ...
        <div className="flex flex-col md:flex-row justify-center opacity-100 w-[500px]">
