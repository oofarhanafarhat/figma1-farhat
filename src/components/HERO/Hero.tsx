...
const Hero = () => {
  return (
    <div >
        ...
        <div className= 'flex mr-0   md:flex md:justify-center md:items-center'>
            <div className='mt-20'>
            ...
            <div className='flex flex-col '>
               <Image src="/Rectangle .png" width={770}height={827} alt='pic here'  className='  w-auto h-auto md:w-[770] md:h-[827] ml-20 mt-20 opacity-100' />
