...
const About = () => {
  return (
    <div className= "w-auto mb-40 justify-center md:flex md:justify-around md:items-center bg-gray-100  md:w-[1170px] md:h-[465px] ml-20 border-2 border-gray-400 border-opacity-100 " >
